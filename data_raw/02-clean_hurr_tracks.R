# This section began from the same code as our `hurricaneexposuredata` package
...
# Bring in latest version of HURDAT2 (as of Jan. 13, 2021)
hurdat2 <- read_lines("https://www.nhc.noaa.gov/data/hurdat/hurdat2-1851-2019-052520.txt")
...
# Extract tracks for 2018 for James, to use as an example to
